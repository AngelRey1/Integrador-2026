Get-ChildItem -Path @('ngx-admin/src/app/pages/cliente', 'ngx-admin/src/app/pages/entrenador', 'sportconnect-admin/src/app/admin/pages') -Recurse -Filter '*.ts' -File | ForEach-Object { import { Component, OnInit, OnDestroy } from '@angular/core';
...
export class UsuariosListComponent implements OnInit, OnDestroy {
 ...
 = Get-Content $_.FullName -Raw; if ($content -match '(?sm)(=\s*\[\s*\{)|(of\(\s*\[)|(mock)|(fake)|(\[\s*\{)') { Write-Output $_.FullName } }
