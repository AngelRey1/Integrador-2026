...
// 4. Update the length access in actualizarConteoSesionesPlan (which used getDiasSeleccionados)
ts = ts.replace(/getDiasSeleccionados\(\)\.length/g, 'this.diasPlanSeleccionadosTemp.length');
